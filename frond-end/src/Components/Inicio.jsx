    ...
    <div>
      <div className='Bienvenido'>
        ...
        <p className='InicioText'>
          Cultivando Sostenibilidad y Calidad en Cada Grano. En el mundo actual, donde la agricultura enfrenta múltiples desafíos, nuestro proyecto surge como una respuesta innovadora y responsable. Nos dedicamos a la producción de fertilizantes naturales que promueven el crecimiento saludable de las plantas, mientras cuidamos de nuestro valioso medio ambiente.
        </p>
      </div>
      ...
      <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img className="d-block w-100" src={Car1} alt="Primera Imagen" />
            
          </div>
          <div className="carousel-item">
            <img className="d-block w-100" src={Car2} alt="Segunda Imagen" />
          </div>
          <div className="carousel-item">
            <img className="d-block w-100" src={Car3} alt="Tercera Imagen" />
          </div>
          <div className="carousel-item">
            <img className="d-block w-100" src={Car4} alt="Cuarta Imagen" />
          </div>
        </div>
      ...
      <section className="py-5">
        <div className="container px-5 my-5">
          ...
          <div className="row gx-5" id='ContentCarde'>
            <div className="col-lg-4 mb-5" id='Cartas'>
              <div className="card h-100 shadow border-0">
                <img className="card-img-top" id='Bocachi' src={Abono} alt="Bocashi" />
            ...
            <div className="col-lg-4 mb-5" id='inicioCArds'>
              <div className="card h-100 shadow border-0">
                <img className="card-img-top" src={Tierra} alt="Tierra Fermentada" />
                <div className="card-body p-4">
          ...
          <div className="sustainability">
            <h2 className="sub-title" style={{ color: '#388e3c' }}>Compromiso con la Sostenibilidad:</h2>
            <p className="description" tyle={{ color: '#6c757d' }}>Utilizamos prácticas de producción que son ecológicas y responsables. Nuestro objetivo es ayudar a restaurar la salud del suelo y reducir el uso de químicos sintéticos, promoviendo así un ciclo de vida natural.</p>
            <br />
          </div>

          <div className="personalized-advisory">
            <h2 className="sub-title" style={{ color: '#388e3c' }}>Asesoría Personalizada:</h2>
          ...
          <div className="quality-assured">
            <h2 className="sub-title" style={{ color: '#388e3c' }}>Calidad Garantizada:</h2>
          ...
          <div className="py-5 bg-light" id='Testi'>
            <div className="container px-5 my-5 text-center">
              <h2 className="fw-bolder" style={{ color: '#388e3c' }}>Testimonio</h2>
              <div className="fs-4 mb-4 fst-italic" style={{ color: 'black' }}>"Desde que empecé a usar los fertilizantes de este proyecto, he notado una gran diferencia en mis cultivos. ¡Mis plantas son más saludables y producen más!" </div>
              <div className="fw-bold" style={{ color: '#388e3c' }}>- Juan Pérez, agricultor local.</div>
            </div>
          </div>
        </div>
      </section>
